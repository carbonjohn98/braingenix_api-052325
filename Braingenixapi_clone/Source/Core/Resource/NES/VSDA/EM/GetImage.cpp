...
Route::Route(Server::Server *_Server, restbed::Service &_Service) {
    ...
    RouteResource->set_path("/NES/VSDA/EM/GetImage");
...
void Route::RouteCallback(const std::shared_ptr<restbed::Session> _Session) {
    ...
    bool UpstreamStatus = Util::NESQueryJSON(Server_->NESClient, Server_->IsNESClientHealthy_, "VSDA/EM/GetImage", UpstreamQuery.dump(), &UpstreamResponseStr);
    if (!UpstreamStatus) {
    ...
    std::cout << "VSDA EM GetImage Called With Sim ID: " << SimID << std::endl;
