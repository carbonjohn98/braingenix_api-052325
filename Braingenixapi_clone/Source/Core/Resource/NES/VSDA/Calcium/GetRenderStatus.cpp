...
Route::Route(Server::Server *_Server, restbed::Service &_Service) {
    ...
    RouteResource->set_path("/NES/VSDA/Calcium/GetRenderStatus");
...
void Route::RouteCallback(const std::shared_ptr<restbed::Session> _Session) {
    ...
    bool UpstreamStatus = Util::NESQueryJSON(Server_->NESClient, Server_->IsNESClientHealthy_, "VSDA/Calcium/GetRenderStatus", UpstreamQuery.dump(), &UpstreamResponseStr);
    if (!UpstreamStatus) {
