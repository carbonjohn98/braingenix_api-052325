...
void Route::RouteCallback(const std::shared_ptr<restbed::Session> _Session) {
    ...
    bool UpstreamStatus = Util::NESQueryJSON(Server_->NESClient, Server_->IsNESClientHealthy_, "VSDA/Calcium/QueueRenderOperation", UpstreamQuery.dump(), &UpstreamResponseStr);
    if (!UpstreamStatus) {
